...
<%@ Register Assembly="DevExpress.Web.v9.2" Namespace="DevExpress.Web.ASPxCallback" TagPrefix="dxcb" %>
<%@ Register Assembly="DevExpress.Web.v9.2" Namespace="DevExpress.Web.ASPxRatingControl" TagPrefix="dxrc" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Vote(s, e){
            Callback.PerformCallback(e.itemIndex);
